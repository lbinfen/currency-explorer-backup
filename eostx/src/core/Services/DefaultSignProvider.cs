...
//https://github.com/GetScatter/eos-sharp/v2.0.8/EosSharp/EosSharp.Core/Providers/DefaultSignProvider.cs
namespace core.Services
{
    ...
    public class DefaultSignProvider : ISignProvider
    {
        ...
        public DefaultSignProvider(string privateKey, string prefix)
        {
            var privKeyBytes = CryptoHelper.GetPrivateKeyBytesWithoutCheckSum(privateKey);
            var pubKey = CryptoHelper.PubKeyBytesToString(Secp256K1Manager.GetPublicKey(privKeyBytes, true), null, prefix);
        ...
        public DefaultSignProvider(List<string> privateKeys, string prefix)
        {
