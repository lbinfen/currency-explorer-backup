...
var web3 = new Web3(new Web3.providers.HttpProvider(getConfig().gethRpc));
...
mongoose.connect(getConfig().mongoUri || process.env.MONGO_URI || 'mongodb://localhost/blockDB');
